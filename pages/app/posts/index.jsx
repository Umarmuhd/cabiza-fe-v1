            ...
            <div className="flex items-center justify-between">
              <div className="hidden md:flex rounded-[100px] shadow-sm mr-6">
                <div className="flex items-center border border-sky_light rounded-full overflow-hidden relative bg-white">
                  ...
                  />
                  <button
                    className="absolute inset-y-0 right-0 flex items-center h-[2rem] my-auto mr-1 px-2 bg-primary rounded-[50%] z-[100] cursor-pointer"
                    type="submit"
                    onClick={changePostsRequestQuery}
                  >
                    <SearchIcon />
                  </button>
                </div>
              ...
              <button
                className="bg-primary_brand_lightest p-[.5rem] mr-4 rounded-full block sm:hidden"
