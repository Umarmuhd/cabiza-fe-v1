...
/* harmony import */ var _styles_index_module_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(44836);
...
/* harmony import */ var react_calendar__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(81749);
/* harmony import */ var react_calendar_dist_Calendar_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(68434);
...
const Payments = () => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
    className: "px-4 sm:px-6 md:px-0 w-full max-w-9xl mx-auto",
    children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("header", {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
        className: "md:w-43/50 mx-auto flex flex-col md:flex-row justify-between",
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
          className: "flex md:mt-0 mt-1 bg-secondary_sky_light rounded-xl border border-secondary_sky_light md:w-[max-content] p-[.1rem] w-full justify-between md:justify-start md:float-left",
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("button", {
            className: `${payout.previous ? 'bg-white text-secondary_ink_light rounded-l-xl' : 'bg-secondary_sky_light text-secondary_brand_light'} h-[2.4rem] w-[11rem] ml-[1px] rounded-l-xl m-auto`,
            onClick: () => setPayout({
              previous: true,
              next: false
            }),
            children: "Previous payouts"
          }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("button", {
            className: `${payout.next ? 'bg-white text-secondary_ink_light rounded-r-xl' : 'bg-secondary_sky_light text-secondary_brand_light'} h-[2.4rem] w-[12rem] ml-[1px] rounded-r-xl m-auto mr-0 md:mr-auto`,
            onClick: () => setPayout({
              previous: false,
              next: true
            }),
          ...
          className: "w-full md:w-auto flex justify-between md:justify-start mt-3 md:mt-0 md:float-right items-center",
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx(next_link__WEBPACK_IMPORTED_MODULE_1__["default"], {
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("a", {
              className: "bg-primary text-white flex items-center py-2 px-4 rounded-full mr-4 h-8",
            ...
            className: "bg-primary text-white flex items-center py-2 px-[.6rem] rounded-[50%] w-8 h-8",
      ...
      className: "md:w-43/50 mx-auto mt-10 bg-white rounded-xl px-6 md:px-12 py-8 md:py-10",
      children: [payout.previous ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.Fragment, {
        children: [showCalendar ? /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("div", {
          ...
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("h3", {
            className: "font-medium text-grey_20 text-lg",
            children: "Select Date"
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
            className: "input flex items-center mt-3 relative",
            children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("input", {
              type: "date",
              name: "date",
              id: "date",
              className: `w-[100%] p-2 px-4 border border-secondary_sky_light rounded-xl appearance-none mr-3 outline-none ${(_styles_index_module_css__WEBPACK_IMPORTED_MODULE_4___default().input)}`,
              ...
              className: `absolute right-0 top-[3rem] z-[100] ${!showCalendar ? "hidden" : ""}`,
              children: /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx(react_calendar__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .ZP, {
                onChange: onChange,
                value: value,
              ...
              children: /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("label", {
                ...
                children: /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx(CalendarIcon, {
                  datepicker: true,
                  "datepicker-autohide": true
                })
              })
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
          className: "bg-primary_brand_darkest text-white rounded-t-xl flex justify-between relative px-10 py-5 items-center",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("svg", {
              ...
              className: "ml-3",
              children: "Previous Payout: March 9th, 2022."
            })]
          }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("p", {
            children: "Activities from 1st January, 2022 to March 9th, 2022. "
          ...
          className: "border border-secondary_sky_base border-t-0 pt-2 pb-4 rounded-b-xl",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
            className: "flex items-center justify-between py-3 text-secondary px-10 mb-1",
            ...
            className: "flex items-center justify-between py-3 text-secondary bg-sky_light px-10 mb-1",
            children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("p", {
              className: "font-normal",
              children: "Fees"
            }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("p", {
            ...
            children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("p", {
              className: "font-normal",
              children: "Affiliate commission paid"
            }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("p", {
              className: " font-bold",
              children: "-$1,567.66"
            })]
            ...
            children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("p", {
              className: "font-normal",
              children: "Paypal Payout (?)"
            }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("p", {
              className: " font-bold",
              children: "$4567.66"
            })]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
            className: "flex items-center justify-between pt-3 text-secondary px-10 mb-1",
            children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("p", {
              className: "font-normal",
              children: "To be sent to Paypal account:"
            }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("p", {
              className: " font-bold",
              children: "$8,567.66"
            })]
