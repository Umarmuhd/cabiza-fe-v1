...
;// CONCATENATED MODULE: ./components/Icons/ProfileIcon.jsx
...
const ProfileIcon = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("svg", {
    ...
    children: [/*#__PURE__*/jsx_runtime.jsx("path", {
      ...
      fill: pathname.includes("/profile") ? "#fff" : "#5B44E9",
      stroke: pathname.includes("/profile") ? "#fff" : "#5B44E9"
...
;// CONCATENATED MODULE: ./components/Icons/ProductsIcon.jsx
...
const ProductsIcon = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("svg", {
    ...
    children: [/*#__PURE__*/jsx_runtime.jsx("path", {
      ...
      fill: pathname.includes("/products") ? "#fff" : "#5B44E9",
      stroke: pathname.includes("/products") ? "#fff" : "#5B44E9"
    }), /*#__PURE__*/jsx_runtime.jsx("path", {
...
/* harmony default export */ const Icons_ProductsIcon = (ProductsIcon);
;// CONCATENATED MODULE: ./components/Icons/PostsIcon.jsx
...
const PostsIcon = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("svg", {
    ...
    children: [/*#__PURE__*/jsx_runtime.jsx("path", {
      ...
      stroke: pathname.includes("/posts") ? "#fff" : "#5B44E9",
      strokeWidth: "1.5",
      strokeLinecap: "round",
...
/* harmony default export */ const Icons_PostsIcon = (PostsIcon);
;// CONCATENATED MODULE: ./components/Icons/PayoutIcon.jsx
...
const PayoutIcon = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("svg", {
    ...
    children: [/*#__PURE__*/jsx_runtime.jsx("path", {
      ...
      stroke: pathname.includes("/payout") ? "#fff" : "#5B44E9",
      strokeWidth: "1.5",
      strokeLinecap: "round",
      strokeLinejoin: "round"
    }), /*#__PURE__*/jsx_runtime.jsx("path", {
...
/* harmony default export */ const Icons_PayoutIcon = (PayoutIcon);
;// CONCATENATED MODULE: ./components/Icons/CommunityIcon.jsx
...
const CommunityIcon = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("svg", {
    ...
    children: [/*#__PURE__*/jsx_runtime.jsx("path", {
      ...
      stroke: pathname === "/community" ? "#fff" : "#5B44E9",
      strokeWidth: "1.5",
      strokeLinecap: "round",
      strokeLinejoin: "round"
    }), /*#__PURE__*/jsx_runtime.jsx("path", {
...
/* harmony default export */ const Icons_CommunityIcon = (CommunityIcon);
;// CONCATENATED MODULE: ./components/Icons/HelpIcon.jsx
...
const HelpIcon = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("svg", {
    ...
    children: [/*#__PURE__*/jsx_runtime.jsx("path", {
      ...
      stroke: pathname === "/help" ? "#fff" : "#5B44E9",
      strokeWidth: "1.5",
      strokeMiterlimit: "10",
      strokeLinecap: "round",
      strokeLinejoin: "round"
...
const SettingsIcon = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("svg", {
    ...
    children: [/*#__PURE__*/jsx_runtime.jsx("path", {
      ...
      stroke: pathname === "/settings" ? "#fff" : "#5B44E9",
      strokeWidth: "1.5",
      strokeMiterlimit: "10",
      strokeLinecap: "round",
      strokeLinejoin: "round"
...
const menus = [{
  path: "/profile",
  title: "Profile",
  icon: Icons_ProfileIcon
}, {
  path: "/products",
  title: "Products",
  icon: Icons_ProductsIcon
}, {
  path: "/posts",
  title: "Posts",
  icon: Icons_PostsIcon
}, {
  path: "/payout",
  title: "Payout",
  icon: Icons_PayoutIcon
}, {
  path: "/community",
  title: "Community",
  icon: Icons_CommunityIcon
}, {
  path: "/help",
  title: "Help",
  icon: Icons_HelpIcon
...
function Sidebar({
  ...
  const sidebar = (0,react.useRef)(null);
  const storedSidebarExpanded = localStorage.getItem("sidebar-expanded");
  const {
    0: sidebarExpanded,
    1: setSidebarExpanded
  } = (0,react.useState)(storedSidebarExpanded === null ? false : storedSidebarExpanded === "true");
  (0,react.useEffect)(() => {
    const clickHandler = ({
      target
    }) => {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    children: [/*#__PURE__*/jsx_runtime.jsx("div", {
      className: `fixed inset-0 bg-white z-40 lg:hidden lg:z-auto transition-opacity duration-200 ${sidebarOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`,
      "aria-hidden": "true"
    }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      id: "sidebar",
      ref: sidebar,
      className: `!fixed border-r border-sec flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 transform h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-[#F2F4F5] md:bg-white p-4 transition-all duration-200 ease-in-out h-[100vh] ${sidebarOpen ? "translate-x-0 !w-full" : "-translate-x-64"}`,
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        ...
        }), /*#__PURE__*/jsx_runtime.jsx("div", {}), /*#__PURE__*/(0,jsx_runtime.jsxs)("button", {
          ref: trigger,
        ...
        children: /*#__PURE__*/jsx_runtime.jsx("div", {
          children: /*#__PURE__*/jsx_runtime.jsx("ul", {
            ...
            children: menus.map(menu => /*#__PURE__*/jsx_runtime.jsx("li", {
              className: `px-3 py-2 rounded-4xl mb-4 last:mb-0 ${pathname.includes(menu.path) && " bg-primary"}`,
              onClick: () => setSidebarOpen(!sidebarOpen),
              children: /*#__PURE__*/jsx_runtime.jsx(next_link["default"], {
                href: menu.path,
                children: /*#__PURE__*/jsx_runtime.jsx("a", {
                  className: `block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes(menu.path) && "hover:text-slate-200"}`,
                  children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
                    className: "flex items-center",
                    children: [menu.icon({
                      pathname
                    }), /*#__PURE__*/jsx_runtime.jsx("span", {
                      className: " ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 text-lg font-medium " + (pathname.includes(menu.path) ? "text-white" : "text-secondary_ink_dark"),
                      children: menu.title
                    })]
                  })
                })
...
// EXTERNAL MODULE: ./context/NavContext.js
var NavContext = __webpack_require__(40766);
;// CONCATENATED MODULE: ./layouts/Dashboard.jsx
...
function Dashboard({
  ...
  const {
    showNav,
    setShowNav
  } = (0,react.useContext)(NavContext/* NavContext */.L);
  const router = (0,next_router.useRouter)();
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/jsx_runtime.jsx(Sidebar, {
      ...
      className: "relative flex flex-col flex-1 overflow-x-hidden bg-secondary_sky_lighter w-[50%] ml-auto",
      children: children
    })]
  });
}
