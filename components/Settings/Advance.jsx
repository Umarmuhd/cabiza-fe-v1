    ...
    <form>
      <Card title='Custom Domain'>
        <div>
          ...
          <div className='border border-sky_light mt-3 h-10 rounded text-secondary_ink_lighter bg-white px-4 w-[100%] mr-2 text-left flex justify-between items-center shadow py-6'>
            <input
              id='uname'
              name='uname'
              className='w-[100%]'
            ...
            />
            <button className='bg-sky_light text-secondary_sky_dark px-3 py-2'>
              Verify
            </button>
          </div>
