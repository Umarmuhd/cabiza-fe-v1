...
export default function BankCard({ data, product }) {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  // const showDropIn = (data, product) => (
  //   <div>
  //     {data.clientToken !== null && product.data ? (
  //       <div>
  //         <DropIn
  ...
  return (
    <div>
      <form onSubmit={handleSubmit(handleContinue)}>
        ...
        <button className="mb-8 md:mb-0 bg-primary rounded-lg text-white w-full p-4 text-center mt-6">
          Pay
        </button>
      </form>
    </div>
