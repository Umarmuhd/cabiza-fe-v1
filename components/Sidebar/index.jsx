            ...
            <ul className="">
              ...
              <li
                className={`px-3 py-2 rounded-4xl mb-4 last:mb-0 ${
                  pathname.includes("/profile") && " bg-primary"
                }`}
                onClick={() => setSidebarOpen(!sidebarOpen)}
              >
                <Link href="/profile">
                    ...
                    <div className="flex items-center">
                      ...
                      >
                        <path
                          ...
                          fill={
                            pathname.includes("/profile") ? "#fff" : "#5B44E9"
                          }
                          stroke={
                            pathname.includes("/profile") ? "#fff" : "#5B44E9"
                          }
                    ...
                    <div className="flex items-center">
                      ...
                      >
                        <path
                          ...
                          fill={
                            pathname.includes("/products") ? "#fff" : "#5B44E9"
                          }
                          stroke={
                            pathname.includes("/products") ? "#fff" : "#5B44E9"
                          }
              ...
              <li
                className={`px-3 py-2 rounded-4xl mb-4 last:mb-0 ${
                  pathname.includes("/posts") && "bg-primary"
                }`}
                onClick={() => setSidebarOpen(!sidebarOpen)}
              >
                <Link href="/posts">
                  <a
                    className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                      pathname.includes("/posts") && "hover:text-slate-200"
                    }`}
                  >
                    <div className="flex items-center">
                      <svg
                      ...
                      >
                        <path
                          ...
                          stroke={
                            pathname.includes("/posts") ? "#fff" : "#5B44E9"
                          }
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
              ...
              <li
                className={`px-3 py-2 rounded-4xl mb-4 last:mb-0 ${
                  pathname.includes("/payout") && "bg-primary"
                }`}
                onClick={() => setSidebarOpen(!sidebarOpen)}
              >
                <Link href="/payout">
                  <a
                    className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                      pathname.includes("/payout") && "hover:text-slate-200"
                    }`}
                  >
                    <div className="flex items-center">
                      <svg
                      ...
                      >
                        <path
                          ...
                          stroke={pathname === "/payout" ? "#fff" : "#5B44E9"}
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
              ...
              <li
                className={`px-3 py-2 rounded-4xl mb-4 last:mb-0 ${
                  pathname.includes("/community") && "bg-primary"
                }`}
                onClick={() => setSidebarOpen(!sidebarOpen)}
              >
                <Link href="/community">
              ...
              <li
                className={`px-3 py-2 rounded-4xl mb-4 last:mb-0 ${
                  pathname.includes("/help") && "bg-primary"
                }`}
                onClick={() => setSidebarOpen(!sidebarOpen)}
              >
                <Link href="/help">
