...
function Notifications() {
  ...
  return (
    <div className='relative inline-flex px-3 ml-3 border-l border-l-secondary_sky_base h-[100%] items-center'>
      <button
        ref={trigger}
      ...
      >
        ...
        <div className='bg-primary_brand_lightest p-2 rounded-full relative'>
          <svg
            width='24'
            height='24'
            viewBox='0 0 24 24'
        ...
        <div className='absolute top-[.1rem] text-xs right-1 bg-[#FF5247] border-2 border-white rounded-full px-1 py-[.1rem]'>7</div>
        </div>
