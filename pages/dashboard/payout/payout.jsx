    ...
    <div className="px-4 sm:px-6 md:px-0 w-full max-w-9xl mx-auto">
      ...
      >
        <div className="md:w-43/50 mx-auto flex flex-col md:flex-row justify-between">
          <div className="flex md:mt-0 mt-1 bg-secondary_sky_light rounded-xl border border-secondary_sky_light md:w-[max-content] p-[.1rem] w-full justify-between md:justify-start md:float-left">
            <button
              className={`${
                payout.previous
          ...
          <div className="w-full md:w-auto flex justify-between md:justify-start mt-3 md:mt-0 md:float-right">
            ...
            <button className="bg-primary text-white flex items-center px-[.6rem] rounded-[50%] w-8 h-8">
              <svg
                width="18"
                height="18"
                viewBox="0 0 16 16"
